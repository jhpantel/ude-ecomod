...
# Announcement January 18 2023
To be ready for class Thursday 19-01-2023:

+ Please bring your laptop to class and be ready to code in R!

+ Please read the following manuscript:

Mühlbauer, L. K., Schulze, M., Harpole, W. S., & Clark, A. T. 2020. gauseR: [__Simple methods for fitting Lotka‐Volterra models describing Gause’s “Struggle for Existence”.__](./r7_Muhlbauer_2020.pdf) Ecology and evolution, 10(23), 13275-13283.

+ Please run this command in R *before* coming to class:
install.packages("gauseR")

+ Please check here by 6pm today (Wednesday 18-01-2023) for additional updates. I might have some files I ask you to download in advance of class (so we can do an internet-free class).
