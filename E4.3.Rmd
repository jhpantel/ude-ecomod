...
rand_disc_lv <- function(N1_0=N1_0,N2_0=N2_0,disc_lv,t){
  ...
  lambda_2r <- runif(1,min=1.2,max=3)
  alpha_22r <- rbeta(1,shape1=1,shape2=50)
  ## Values for competition
  alpha_12r <- rbeta(1,shape1=1,shape2=50)
  alpha_21r <- rbeta(1,shape1=1,shape2=50)
...
lambda_1 <- mean(rej_log$adj.values[,1])
alpha_11 <- mean(rej_log$adj.values[,2])
lambda_2 <- mean(rej_log$adj.values[,3])
alpha_22 <- mean(rej_log$adj.values[,4])
alpha_12 <- mean(rej_log$adj.values[,5])
alpha_21 <- mean(rej_log$adj.values[,6])
## Initial population sizes
N1_0 <- species$P_caudatum[1]
N2_0 <- species$P_aurelia[1]
t <- 23
