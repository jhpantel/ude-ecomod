...
```{r tidy=TRUE, tidy.opts=list(width.cutoff=60),out.width="50%",warning = FALSE, message = FALSE, echo=TRUE, results='hide'}
# Parameter values to use for simulation
r <- 2.2
K <- 1400
N0 <- 4
...
```{r tidy=TRUE, tidy.opts=list(width.cutoff=60),warning = FALSE, message = FALSE,results='hide', fig.cap='A figure of population size over time using the discrete-time logistic growth model'}
# Parameter values to use for simulation
