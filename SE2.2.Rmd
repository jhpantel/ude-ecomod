---
title: "Solutions: Exercise 2.2 - Survey of ecological models, Part 2"
...
# We read this directly from the graph: 2, 2, 2, 2, 2, 4
```
...
```{r tidy=TRUE, tidy.opts=list(width.cutoff=60),warning = FALSE, message = FALSE,fig.cap='A figure of population size over time using the discrete-time logistic growth model'}
# Parameter values to use for simulation
