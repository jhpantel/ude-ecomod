...
a <- c(5,13,2,NA)
mean(a)
?mean # Sorry for the typo, this should read as ?mean - I am having some trouble with R Markdown
mean(a,na.rm=TRUE)
```
...
```{r tidy=TRUE, tidy.opts=list(width.cutoff=60), echo=TRUE, eval=FALSE}
a <- c(5,13,2,NA)
mean(a)
mean(a,na.rm=TRUE)
```
