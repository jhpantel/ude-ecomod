---
title: "Exercise 2.1 - Survey of ecological models, Part 2"
...
`r1 = 0.3, r2 = 0.5, K1 = 1,400, K2 = 1,000, alpha_12 = 1.1, alpha_21 = 0.6, N1_0 = 5, N2_0 = 5`
...
```{r tidy=TRUE, tidy.opts=list(width.cutoff=60),warning = FALSE, message = FALSE, echo=FALSE}
# Parameter values to use for simulation
parameters <- c(r1 = 0.3, r2 = 0.5, K1 = 1,400, K2 = 1,000, alpha_12 = 1.1, alpha_21 = 0.6)
state      <- c(N1 = 5, N2 = 5)
