...
plot(dp$week,dp$dm,pch=19,col="orange", main = "Daphnia population size", xlab = "cell length (micrometers)", ylab = "P (micrograms / liter)")
points(dp$week,dp$dp,pch=19,col="black")
legend("topright",legend=c("D. magna","D. pulex"),pch=19,col=c("orange","black"))
```
```{r echo=FALSE,eval=FALSE}
sub <- read.csv('https://github.com/jhpantel/ude-ecomod/data/sub.csv')
