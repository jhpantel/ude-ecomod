...
7. The final step is to get this modified code uploaded to your GitHub repository (so I can see it on github.com).

* In Terminal or Git Bash (the command line interface you were at previously), make sure you are still in the *ude-ecomod-hw* directory. You can check if this is the case by typing `pwd`.
